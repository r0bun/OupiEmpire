...
public class JeuxOupi implements Dessinable {
	...
	public void creeTailleTuile() {
		// taille = taille du composant c-a-d screenWidth/2 diviser par le nombre de
		// tuiles
	 ...
	 * @return la troupe à la position spécifiée, ou {@code null} si aucune troupe
	 *         n'est trouvée
	 */
	...
	public boolean attaquerTroupe(Troupe troupeCible) {
		...
		// Vérifier si la cible est à portée d'attaque (distance 1 pour attaque corps à
		// corps)
		if (distance > 1) {
		...
		System.out.println("🗡️ Attaque initiée par " + troupeSelectionnee.getClass().getSimpleName() + " contre "
				+ troupeCible.getClass().getSimpleName());
